  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        ...
        // Consultar el rol del usuario en la tabla public.profiles
        ...
        setMessage({ type: 'success', text: `¡Bienvenido! Rol identificado: ${role.toUpperCase()}. Cargando tu panel...` })
    ...
    <div className="min-h-screen bg-slate-950 text-white flex items-center justify-center p-4 font-sans">
      <div className="max-w-md w-full bg-slate-900 border border-slate-800 rounded-3xl p-8 shadow-2xl space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-400">Portal de Acceso Unificado RBAC (Admin, Docente, Estudiante)</p>
        </div>
        ...
        {/* SELECCIÓN DIRECTA DE ENTORNO POR ROL (DEMO RBAC) */}
        <div className="pt-5 border-t border-slate-800 space-y-3">
          <p className="text-[11px] text-slate-400 font-bold uppercase tracking-wider text-center">
            O selecciona tu Entorno por Rol (Acceso Directo RBAC):
          </p>
          ...
          <div className="grid grid-cols-3 gap-2">
            ...
            <button
              ...
              className="p-3 bg-slate-950 hover:bg-slate-800 border border-slate-800 hover:border-crimson-500/50 rounded-2xl flex flex-col items-center text-center space-y-1.5 transition-all group"
            >
            ...
            <button
              ...
              className="p-3 bg-slate-950 hover:bg-slate-800 border border-slate-800 hover:border-blue-500/50 rounded-2xl flex flex-col items-center text-center space-y-1.5 transition-all group"
            >
            ...
            <button
              ...
              className="p-3 bg-slate-950 hover:bg-slate-800 border border-slate-800 hover:border-emerald-500/50 rounded-2xl flex flex-col items-center text-center space-y-1.5 transition-all group"
            >
