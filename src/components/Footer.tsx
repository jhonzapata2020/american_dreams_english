  ...
  return (
    <footer className="bg-navy-950 text-slate-300 pt-16 pb-8 border-t border-navy-900 font-sans text-xs">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* TOP INSTITUTIONAL ALLIANCE BANNER */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-slate-400 leading-relaxed">
              Plataforma educativa oficial operada por <strong>American Dream English S.A.S.</strong> en alianza tecnológica con <strong>Corplex Solutions S.A.S.</strong>
            </p>
            <div className="pt-1 flex items-center space-x-2 text-[11px] text-amber-400 font-bold">
              <Award className="w-4 h-4 text-amber-400" /> 12 Años Formando en Urabá
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-slate-400">
              ...
              <li><a href="#segmentos" className="hover:text-white transition-colors">3. Clases Virtuales en Vivo (Zoom/Teams)</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-slate-400">
              <li className="flex items-start space-x-2">
                ...
                <span>Distrito de Turbo, Antioquia — Región de Urabá, Colombia</span>
              </li>
              <li className="flex items-center space-x-2">
                <Building2 className="w-4 h-4 text-indigo-400 flex-shrink-0" />
                <span>NIT / Registro S.A.S. Oficial</span>
              </li>
              <li className="flex items-center space-x-2">
          ...
          <div>
            ...
            <div className="p-3 bg-navy-900 border border-slate-800 rounded-xl text-[11px] text-slate-300 flex items-center gap-2">
              ...
              <span>Procesamiento Encriptado con Pasarelas Oficiales</span>
            </div>
          </div>
        ...
        <div className="border-t border-slate-800/80 pt-6 flex flex-col sm:flex-row items-center justify-between text-slate-500 text-[11px] gap-2">
          ...
          <div className="flex space-x-4">
            ...
            <a href="#" className="hover:text-slate-300 transition-colors">Auditoría de Becas</a>
          </div>
        </div>
